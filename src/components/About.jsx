...
const ServiceCard = ({ index, title, icon }) => {
  ...
  return (
    <Tilt ref={tiltRef} className="xs:w-[240px] w-full" options={{ max: 45, scale: 1, speed: 500 }}>
      <motion.div
  ...
  return (
    <>
      ...
      <motion.p variants={fadeIn("", ", 0.1, 1")} className="mt-4 text-secondary text-[17px] max-w-3x1 leading-[30px]">
        I'm a full stack web developer with experience in JavaScript expertise in frameworks like React, node.js & Three.js.
