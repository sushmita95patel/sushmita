  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)} >
      ...
      options={{
       ...
       className="bg-tertiary p-5 rounded-2x1 sm:w-[380px] w-full"
      >
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        <motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-3 text-secondery text-[17px] max-w-3x1 leading-[30px]">
          Following projects showcase my skills and experience through real-world examples of my work. Each project is
          briefly described with links to code repositories and live demos. It reflects my ability to solve problems,
...
export default SectionWrapper(Work, "Projects"); // You need to pass the appropriate second argument to SectionWrapper
